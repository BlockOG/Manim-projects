...
class SquareToCircle(Scene):
    def construct(self):
        ...
        text = Text("These are some transformation tests")
        myexpression = Text(":)")
        secondtext = Text("And I like this transformation")
        secondtexttop = Text("And I like this transformation")
        secondtexttop.set_color("#333333")
        ...
        self.play(Transform(AnimatedObject, square))

        self.wait(0.4)

        self.play(Transform(AnimatedObject, text))

        self.wait()


        self.play(Transform(AnimatedObject, myexpression))

        self.wait()

        self.play(Write(secondtexttop))
        self.remove(AnimatedObject, secondtexttop)
...
class GraphExample(Scene):
    def construct(self):
        ...
        self.play(FadeIn(dot, scale=0.5), run_time=.5)
        ...
        self.play(x_tracker.set_value, 4, run_time=.5)
        self.play(x_tracker.set_value, -2, run_time=.5)
        self.wait()
...
class SurfaceExample(Scene):
    ...
    def construct(self):
        ...
        rect = Rectangle(height=2, width=10)
        torus1 = Torus(r1=1, r2=1)
        torus2 = Torus(r1=4, r2=2)
